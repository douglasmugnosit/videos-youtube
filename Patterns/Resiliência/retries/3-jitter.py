...
def retry(funcao, max_tentativas, espera_inicial, jitter_max):
    tentativa = 0
    ...
    while tentativa < max_tentativas:
        try:
            ...
            if tentativa < max_tentativas:
                espera_jitter = random.uniform(0, jitter_max)
                espera_total = espera_atual + espera_jitter
...
# Exemplo de uso
try:
    resultado = retry(funcao_a_ser_retried, max_tentativas=5, espera_inicial=1, jitter_max=0.5)
